...
@Component({
  selector: 'app-checkbox-desratizacion',
  imports: [],
  templateUrl: './checkbox-desratizacion.component.html',
  styleUrl: './checkbox-desratizacion.component.scss'
})
export class CheckboxDesratizacionComponent {
