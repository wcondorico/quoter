...
@Component({
  selector: 'app-checkbox-desinfeccion',
  imports: [],
  templateUrl: './checkbox-desinfeccion.component.html',
  styleUrl: './checkbox-desinfeccion.component.scss'
})
export class CheckboxDesinfeccionComponent {
